...
authenticate=function(token){a=token;for(x=1;x<=a;x++){c=a/x;d=Math.floor(c);}pf="";b=a;for(e=2;e<=Math.floor(a/2);e++){while(b/e==Math.floor(b/e)){if(b/e==Math.floor(b/e)){pf=pf+e+"x";b=b/e;}}}pfl=pf.length;pf=pf.substr(0,(pfl-1));return pf;}
