      ...
      module SingletonMethods
        ...
        def find_options_for_find_tagged_with(tags, options = {})
          ...
          { :select => "DISTINCT #{table_name}.*",
            :joins => "INNER JOIN #{RisingCode::Models::Tagging.table_name} #{taggings_alias} ON #{taggings_alias}.taggable_id = #{table_name}.#{primary_key} AND #{taggings_alias}.taggable_type = #{quote_value(base_class.name)} " +
...
Camping::Models::Base.send(:include, Taggable)
